...
<div class="content-inner narrow">
			...
			<tbody>
				...
				<tr>
					<td colspan="3" class="actions">
						<a href="<?php echo get_site_url() ?>/products" class="g-btn"><i class="fa fa-play-circle"></i> Continue Shopping</a>
						<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
						<?php do_action( 'woocommerce_cart_actions' ); ?>
						<?php wp_nonce_field( 'woocommerce-cart', 'woocommerce-cart-nonce' ); ?>
					</td>
					<td colspan="3" class="table-total">
						<span>Total: </span><?php wc_cart_totals_order_total_html(); ?>
					</td>
				</tr>
	...
	<div class="cart-page-bottom">
		...
		<div class="cart-collaterals col-2">
			<div class="cart-box-title">
				SHOPPING CART TOTAL
			</div>
			<div class="cart-box-content">
